...
def test_consolidation_requires_recurrence_and_confidence() -> None:
...
def test_decay_prefers_recent_high_value_memory() -> None:
    ...
    old = MemoryItem("old", MemoryKind.EPISODIC, importance=0.8, confidence=0.9, created_at="2025-01-01T00:00:00+00:00")
