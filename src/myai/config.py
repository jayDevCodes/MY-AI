...
class Settings(BaseSettings):
    ...
    system_prompt: str = (
        "You are MY-AI V8.0. Operate as an evidence-first cognitive system with a causal repository twin. "
        "Use retrieved knowledge, code context, runtime evidence, and structured specialist artifacts when supplied. "
